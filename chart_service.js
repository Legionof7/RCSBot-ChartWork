...
async function renderChartFromReactCode(
  ...
  console.log("######################## Received React chart code:");
  ...
  try {
    ...
    const htmlContent = `
      ...
      <html>
        ...
        <body style="margin: 0; background: white; display: flex; justify-content: center; align-items: center; height: 100vh;">
            <div id="root" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">${chartHTML}</div>
        </body>
      </html>`;
    ...
    await page.setViewport({ width: 1020, height: 820 }); // Slightly larger than the chart
...
app.post("/render-react-chart", async (req, res) => {
  console.log("react code generated by gemini");
